...
- **Colors:** Primary: blue, Secondary: emerald, Neutral: slate
...
- **Comment** — Communications related to tickets
- **Notification** — Automated messages about ticket changes
...
- `/submit` — User Ticket Submission
- `/admin` — Admin Dashboard & Management
- `/status` — Status Tracking & Notifications
- `/portal` — User Portal & Reporting
